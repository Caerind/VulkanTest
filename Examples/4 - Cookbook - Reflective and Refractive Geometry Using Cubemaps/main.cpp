...
class Sample : public SampleBase
{
	...
	nu::Vulkan::GraphicsPipeline::Ptr mModelPipeline;
	nu::Vulkan::GraphicsPipeline::Ptr mSkyboxPipeline;
	...
	virtual bool initialize(nu::Vulkan::WindowParameters windowParameters) override 
	{
		...
		if (!getBinaryFileContents("../Data/Shaders/modelShader.vert.spv", modelVertexShaderSpirv)) 
		{
			return false;
		}
		nu::Vulkan::ShaderModule::Ptr modelVertexShaderModule = mLogicalDevice->createShaderModule(nu::Vulkan::ShaderModule::Vertex, modelVertexShaderSpirv);
		if (modelVertexShaderModule == nullptr || !modelVertexShaderModule->isInitialized())
		{
			return false;
		}

		std::vector<unsigned char> modelFragmentShaderSpirv;
		if (!getBinaryFileContents("../Data/Shaders/modelShader.frag.spv", modelFragmentShaderSpirv)) 
		{
			return false;
		}
		nu::Vulkan::ShaderModule::Ptr modelFragmentShaderModule = mLogicalDevice->createShaderModule(nu::Vulkan::ShaderModule::Fragment, modelFragmentShaderSpirv);
		if (modelFragmentShaderModule == nullptr || !modelFragmentShaderModule->isInitialized())
		{
			return false;
		}

		std::vector<VkPipelineShaderStageCreateInfo> modelShaderStageCreateInfos = { 
			modelVertexShaderModule->getShaderStageCreateInfo(), 
			modelFragmentShaderModule->getShaderStageCreateInfo() 
		};
		...
		VkPipelineVertexInputStateCreateInfo modelVertexInputStateCreateInfo = {
			...
			static_cast<uint32_t>(modelVertexInputBindingDescriptions.size()), // uint32_t                                  vertexBindingDescriptionCount
			modelVertexInputBindingDescriptions.data(),                        // const VkVertexInputBindingDescription   * pVertexBindingDescriptions
			static_cast<uint32_t>(modelVertexAttributeDescriptions.size()),    // uint32_t                                  vertexAttributeDescriptionCount
			modelVertexAttributeDescriptions.data()                            // const VkVertexInputAttributeDescription * pVertexAttributeDescriptions
		};

		// Skybox

		std::vector<unsigned char> skyboxVertexShaderSpirv;
		if (!getBinaryFileContents("../Data/Shaders/skyboxShader.vert.spv", skyboxVertexShaderSpirv))
		{
			return false;
		}
		nu::Vulkan::ShaderModule::Ptr skyboxVertexShaderModule = mLogicalDevice->createShaderModule(nu::Vulkan::ShaderModule::Vertex, skyboxVertexShaderSpirv);
		if (skyboxVertexShaderModule == nullptr || !skyboxVertexShaderModule->isInitialized())
		{
			return false;
		}

		std::vector<unsigned char> skyboxFragmentShaderSpirv;
		if (!getBinaryFileContents("../Data/Shaders/skyboxShader.frag.spv", skyboxFragmentShaderSpirv))
		{
			return false;
		}
		nu::Vulkan::ShaderModule::Ptr skyboxFragmentShaderModule = mLogicalDevice->createShaderModule(nu::Vulkan::ShaderModule::Fragment, skyboxFragmentShaderSpirv);
		if (skyboxFragmentShaderModule == nullptr || !skyboxFragmentShaderModule->isInitialized())
		{
			return false;
		}

		std::vector<VkPipelineShaderStageCreateInfo> skyboxShaderStageCreateInfos = {
			skyboxVertexShaderModule->getShaderStageCreateInfo(),
			skyboxFragmentShaderModule->getShaderStageCreateInfo()
		};
		...
		VkPipelineVertexInputStateCreateInfo skyboxVertexInputStateCreateInfo = {
			...
			nullptr,                                                      // const void                              * pNext
			0,                                                            // VkPipelineVertexInputStateCreateFlags     flags
			static_cast<uint32_t>(skyboxVertexInputBindingDescriptions.size()), // uint32_t                                  vertexBindingDescriptionCount
			skyboxVertexInputBindingDescriptions.data(),                        // const VkVertexInputBindingDescription   * pVertexBindingDescriptions
			static_cast<uint32_t>(skyboxVertexAttributeDescriptions.size()),    // uint32_t                                  vertexAttributeDescriptionCount
			skyboxVertexAttributeDescriptions.data()                            // const VkVertexInputAttributeDescription * pVertexAttributeDescriptions
		};
		...
		VkGraphicsPipelineCreateInfo modelPipelineCreateInfo = {
			...
			static_cast<uint32_t>(modelShaderStageCreateInfos.size()),       // uint32_t                                       stageCount
			modelShaderStageCreateInfos.data(),                              // const VkPipelineShaderStageCreateInfo        * pStages
			&modelVertexInputStateCreateInfo,                                // const VkPipelineVertexInputStateCreateInfo   * pVertexInputState
			&inputAssemblyStateCreateInfo,                              // const VkPipelineInputAssemblyStateCreateInfo * pInputAssemblyState
			nullptr,                                                    // const VkPipelineTessellationStateCreateInfo  * pTessellationState
			&viewportStateCreateInfo,                                   // const VkPipelineViewportStateCreateInfo      * pViewportState
			&modelRasterizationStateCreateInfo,                              // const VkPipelineRasterizationStateCreateInfo * pRasterizationState
		...
		mModelPipeline = mLogicalDevice->createGraphicsPipeline(modelPipelineCreateInfo, nullptr);
		if (mModelPipeline == nullptr)
		{
			return false;
		}
		...
		VkGraphicsPipelineCreateInfo skyboxPipelineCreateInfo = {
			...
			nullptr,                                                    // const void                                   * pNext
			0,                                                          // VkPipelineCreateFlags                          flags
			static_cast<uint32_t>(skyboxShaderStageCreateInfos.size()),       // uint32_t                                       stageCount
			skyboxShaderStageCreateInfos.data(),                              // const VkPipelineShaderStageCreateInfo        * pStages
			&skyboxVertexInputStateCreateInfo,                                // const VkPipelineVertexInputStateCreateInfo   * pVertexInputState
			&inputAssemblyStateCreateInfo,                              // const VkPipelineInputAssemblyStateCreateInfo * pInputAssemblyState
			nullptr,                                                    // const VkPipelineTessellationStateCreateInfo  * pTessellationState
			&viewportStateCreateInfo,                                   // const VkPipelineViewportStateCreateInfo      * pViewportState
			&skyboxRasterizationStateCreateInfo,                              // const VkPipelineRasterizationStateCreateInfo * pRasterizationState
			&multisampleStateCreateInfo,                                // const VkPipelineMultisampleStateCreateInfo   * pMultisampleState
			&depthStencilStateCreateInfo,                               // const VkPipelineDepthStencilStateCreateInfo  * pDepthStencilState
			&blendStateCreateInfo,                                      // const VkPipelineColorBlendStateCreateInfo    * pColorBlendState
			&dynamicStateCreateInfo,                                    // const VkPipelineDynamicStateCreateInfo       * pDynamicState
		...
		mSkyboxPipeline = mLogicalDevice->createGraphicsPipeline(skyboxPipelineCreateInfo, nullptr);
		if (mSkyboxPipeline == nullptr)
		{
			return false;
		}
	...
	virtual bool draw() override 
	{
		auto prepareFrame = [&](nu::Vulkan::CommandBuffer* commandBuffer, uint32_t swapchainImageIndex, nu::Vulkan::Framebuffer* framebuffer) 
		{
			...
			commandBuffer->bindPipelineObject(VK_PIPELINE_BIND_POINT_GRAPHICS, mModelPipeline->getHandle());
			...
			commandBuffer->bindPipelineObject(VK_PIPELINE_BIND_POINT_GRAPHICS, mSkyboxPipeline->getHandle());
